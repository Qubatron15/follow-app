...
| Dashboard Threads | `/threads/` | Zakładki wątków, sekcja Transkrypcja, sekcja AP, globalny toast | `ThreadTabs`, `TextareaTranscript`, `ButtonGenerate`, `APList`, `ToastProvider`, `SpinnerOverlay`, `AnchorSidebar` | blokada przycisku generacji gdy transcript dirty, kontenery landmark `<main>` |
